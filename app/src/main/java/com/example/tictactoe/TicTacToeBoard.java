...
public class TicTacToeBoard extends View {
    ...
    private  final int lineWining;
    private  final  int OColor;
    private  final  int winnigLineColor;
    private boolean winnegLine = false;
    ...
    public TicTacToeBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            winnigLineColor=a.getInteger(R.styleable.TicTacToeBoard_winnigLineColor,0);
            lineWining = a.getInteger(R.styleable.TicTacToeBoard_lineWiners,0);
        }finally {
            a.recycle();
        }
    }
